...
| SHT-25 | reviewed_invariant | A previz board is a proposal, not an authority: its drawing medium is deliberately unlike the finished look, its annotation legend is declared and stays on the board layer—never copied into a delivery frame, where arrows, labels, and panel numbers would be read as things to draw—and it may propose a shot progression without becoming a shot-count formula. Coverage and the shot list still decide the shots. |
